...
std::cout<<"DEBUG Segmentation fault:: route_constructor:: before adding input and stereo"<<std::endl;

    add_input(hs);
    add_stereo(hs);//ADD CONDITION ABOUT CHECKING THE HARDWARE SPECIFICATIONS
std::cout<<"DEBUG Segmentation fault:: route_constructor:: added input and stereo"<<std::endl;
...
std::cout<<"DEBUG Segmentation fault:: route::connect_all:: connect_input_device"<<std::endl;
        hs->connect_input_device(0,tp.input_port);
    }
    if (tp.output_port_left!=NULL && tp.output_port_right!=NULL){
std::cout<<"DEBUG Segmentation fault:: route::connect_all:: connect_output_device(0,tp.output_port_left)"<<std::endl;
        hs->connect_output_device(0,tp.output_port_left);
//std::cout<<"DEBUG Segmentation fault:: route::connect_all::hs->connect_output_device(1,tp.output_port_right);"<<std::endl;
        //hs->connect_output_device(1,tp.output_port_right);
    }
    if (tp.output_port_mono!=NULL){
std::cout<<"DEBUG Segmentation fault:: route::connect_all:: connect_output_device(0,tp.output_port_mono)"<<std::endl;
