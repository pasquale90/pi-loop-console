...
std::cout<<"DEBUG Segmentation fault:: handshake::activate:: before jack_activate"<<std::endl;

    jack_deactivate(client);

    std::cout<<"jack _deactivated"<<std::endl;
...
std::cout<<"DEBUG Segmentation fault:: handshake::activate:: after jack_activate"<<std::endl;
}
